...
In der Klimakammer findet der Verdampfungsprozess statt. Neben dem Verdampfer ist hier das Expansionsventil und die Versorgungsmimik installiert. Die Versorgungsmimik erlaubt drei verschiedene Durchströmungswege durch den Verdampfer. Die Abbildung \ref{fig:Magnetventil} sind die Varianten mit den Magnetventilstellungen abgebildet. 

\begin{figure}[htb]
%\centering	
\includegraphics[ page=4, width=1.150\textwidth]{Pictures/RI.pdf}
\caption{Kälteanlage-Fließbild}
